                    ...
                    if(err){
                        ...
                        (err, results)=>{
                            if(err){
                                ...
                                db.query('insert into tb_pinjam set ?',
                                [data],
                                (err, results)=>{
                                    if(err){
                                        return callBack(err);
...
get : (callBack)=>{
    db.query('select * from tb_pinjam',
    [],
    (err, results)=>{
        if(err){
            return callBack(err);
...
getId : (data, callBack)=>{
    db.query('select * from tb_pinjam where no_pinjam =?',
    [data],
    (err, results)=>{
        if(err){
            return callBack(err);
...
del : (data, callBack)=>{
    db.query('select no_pinjam from tb_pinjam where no_pinjam =?',
    [data.no_pinjam],
    (err, results)=>{
        if(err){
            return callBack(err);
        }else{
            db.query('delete from tb_pinjam where no_pinjam =?',
            [data.no_pinjam],
           (err, results)=>{
               if(err){
                   return callBack(err);
